...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-15 at commit `1fe0710`. Do not edit by hand — regenerate.*

| Split | Config | Mis-lock | Median err (px) | pass@1px | pass@0.5px | Runtime p50 |
|---|---|---|---|---|---|---|
| **sponsor `verify`** (40) | baseline | 25.0% | 1.102 | 40.0% | 17.5% | 85 ms |
| *their generator, fixed 10:1, no rotation* | **DriftLock** | **0.0%** | **0.179** | **97.5%** | **92.5%** | 2166 ms (25x base) |
| **bench** (30) | baseline | 76.7% | 326.905 | 10.0% | 3.3% | 87 ms |
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **20.0%** | **0.330** | **76.7%** | **63.3%** | 1927 ms (23x base) |
| **holdout FinFET** (30) | baseline | 90.0% | 359.893 | 3.3% | 3.3% | 85 ms |
| *held-out architecture, never tuned on* | **DriftLock** | **6.7%** | **0.214** | **86.7%** | **73.3%** | 1984 ms (23x base) |

**Aggregate mis-lock across all 100 evaluated pairs: 8/100 = 8.0%.**
