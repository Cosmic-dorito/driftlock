...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-14 at commit `e393d9f`. Do not edit by hand — regenerate.*

| Split | Config | Mis-lock | Median err (px) | pass@1px | pass@0.5px | Runtime p50 |
|---|---|---|---|---|---|---|
| **sponsor `verify`** (40) | baseline | 25.0% | 1.102 | 40.0% | 17.5% | 20 ms |
| *their generator, fixed 10:1, no rotation* | **DriftLock** | **22.5%** | **0.275** | **75.0%** | **70.0%** | 407 ms |
| **bench** (30) | baseline | 76.7% | 326.905 | 10.0% | 3.3% | 20 ms |
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **16.7%** | **0.337** | **76.7%** | **63.3%** | 388 ms |
| **holdout FinFET** (30) | baseline | 90.0% | 359.893 | 3.3% | 3.3% | 20 ms |
| *held-out architecture, never tuned on* | **DriftLock** | **13.3%** | **0.201** | **83.3%** | **66.7%** | 388 ms |

**Aggregate mis-lock across all 100 evaluated pairs: 18/100 = 18.0%.**
