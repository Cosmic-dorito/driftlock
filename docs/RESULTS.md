...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-18 at commit `7ae09b1`. Do not edit by hand — regenerate.*

| Split | Config | Mis-lock | Median err (px) | pass@1px | pass@0.5px | Runtime p50 |
|---|---|---|---|---|---|---|
| **sponsor `verify`** (40) | baseline | 25.0% | 1.102 | 40.0% | 17.5% | 19 ms |
| *their generator, fixed 10:1, no rotation* | **DriftLock** | **0.0%** | **0.179** | **97.5%** | **92.5%** | 672 ms (36x base) |
| **bench** (30) | baseline | 76.7% | 326.905 | 10.0% | 3.3% | 19 ms |
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **13.3%** | **0.300** | **83.3%** | **66.7%** | 604 ms (32x base) |
| **holdout FinFET** (30) | baseline | 90.0% | 359.893 | 3.3% | 3.3% | 18 ms |
| *held-out architecture, never tuned on* | **DriftLock** | **3.3%** | **0.214** | **90.0%** | **76.7%** | 621 ms (33x base) |
