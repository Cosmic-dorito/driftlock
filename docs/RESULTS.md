...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-15 at commit `29349a1`. Do not edit by hand — regenerate.*

| Split | Config | Mis-lock | Median err (px) | pass@1px | pass@0.5px | Runtime p50 |
|---|---|---|---|---|---|---|
| **sponsor `verify`** (40) | baseline | 25.0% | 1.102 | 40.0% | 17.5% | 20 ms |
| *their generator, fixed 10:1, no rotation* | **DriftLock** | **20.0%** | **0.251** | **77.5%** | **72.5%** | 406 ms (21x base) |
| **bench** (30) | baseline | 76.7% | 326.905 | 10.0% | 3.3% | 19 ms |
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **16.7%** | **0.342** | **76.7%** | **63.3%** | 397 ms (20x base) |
| **holdout FinFET** (30) | baseline | 90.0% | 359.893 | 3.3% | 3.3% | 20 ms |
| *held-out architecture, never tuned on* | **DriftLock** | **10.0%** | **0.220** | **83.3%** | **70.0%** | 391 ms (20x base) |
