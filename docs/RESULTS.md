...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-15 at commit `68d1ef0`. Do not edit by hand — regenerate.*
...
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **16.7%** | **0.300** | **80.0%** | **66.7%** | 568 ms (29x base) |
...
**Aggregate mis-lock across all 100 evaluated pairs: 6/100 = 6.0%.**
