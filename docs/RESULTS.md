...
*Generated by `scripts/make_results_doc.py` from `results/` on 2026-08-15 at commit `888b38e`. Do not edit by hand — regenerate.*

| Split | Config | Mis-lock | Median err (px) | pass@1px | pass@0.5px | Runtime p50 |
|---|---|---|---|---|---|---|
| **sponsor `verify`** (40) | baseline | 25.0% | 1.102 | 40.0% | 17.5% | 19 ms |
| *their generator, fixed 10:1, no rotation* | **DriftLock** | **5.0%** | **0.195** | **92.5%** | **87.5%** | 394 ms (21x base) |
| **bench** (30) | baseline | 76.7% | 326.905 | 10.0% | 3.3% | 19 ms |
| *ours: 9–11:1 magnification, ±2° rotation, DRAM* | **DriftLock** | **23.3%** | **0.357** | **73.3%** | **60.0%** | 377 ms (20x base) |
| **holdout FinFET** (30) | baseline | 90.0% | 359.893 | 3.3% | 3.3% | 18 ms |
| *held-out architecture, never tuned on* | **DriftLock** | **6.7%** | **0.214** | **86.7%** | **73.3%** | 382 ms (20x base) |

**Aggregate mis-lock across all 100 evaluated pairs: 11/100 = 11.0%.**
