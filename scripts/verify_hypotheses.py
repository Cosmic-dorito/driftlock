...
The facts in docs/SPEC.md were derived by READING the sponsor's published generator, not by running
...
def main() -> int:
    ...
    with OUT.open("w", encoding="utf-8") as fh:
        ...
        fh.write("The facts in `docs/SPEC.md` were derived by reading source code. Reading is not "
                 "evidence; this is.\n\n")
        for v in verdicts:
