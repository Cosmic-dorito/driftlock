...
| ** + screened wide refit + median  [DEFAULT] ** | 0.0% | 20.0% | 6.7% |
|    the DEFAULT minus the median filter | 7.5% | 26.7% | 10.0% |
|    the DEFAULT minus pose evidence | 20.0% | 16.7% | 10.0% |
|    the DEFAULT with the old top_n=10 screen | 5.0% | 23.3% | 6.7% |
|    the DEFAULT with the old top_n=10 screen and no pose evidence | 20.0% | 16.7% | 10.0% |
...
| ** + screened wide refit + median  [DEFAULT] ** | 0.179 | 0.330 | 0.214 |
|    the DEFAULT minus the median filter | 0.194 | 0.408 | 0.201 |
...
| ** + screened wide refit + median  [DEFAULT] ** | 97.5% | 76.7% | 86.7% |
|    the DEFAULT minus the median filter | 90.0% | 70.0% | 86.7% |
|    the DEFAULT minus pose evidence | 77.5% | 76.7% | 83.3% |
|    the DEFAULT with the old top_n=10 screen | 92.5% | 73.3% | 86.7% |
|    the DEFAULT with the old top_n=10 screen and no pose evidence | 77.5% | 76.7% | 83.3% |
...
| ** + screened wide refit + median  [DEFAULT] ** | 92.5% | 63.3% | 73.3% |
|    the DEFAULT minus the median filter | 85.0% | 56.7% | 70.0% |
|    the DEFAULT minus pose evidence | 72.5% | 63.3% | 70.0% |
|    the DEFAULT with the old top_n=10 screen | 87.5% | 60.0% | 73.3% |
|    the DEFAULT with the old top_n=10 screen and no pose evidence | 72.5% | 63.3% | 70.0% |
...
| Stage | sponsor | bench | finfet |
|---|---|---|---|
| baseline (sponsor: INTER_AREA + ZNCC argmax) | 20 | 81 | 69 |
| + sub-pixel DFT (A9) | 217 | 147 | 126 |
| + blind drift correction | 173 | 167 | 155 |
| + sub-pixel + drift | 320 | 99 | 214 |
| + pose: spectral lattice  [LESS ACCURATE] | 1195 | 1123 | 976 |
| + pose: pyramid | 743 | 760 | 665 |
| + per-candidate pose refit, narrow | 926 | 1001 | 900 |
| ** + screened wide refit + median  [DEFAULT] ** | 1800 | 1899 | 1711 |
|    the DEFAULT minus the median filter | 1984 | 1713 | 1799 |
|    the DEFAULT minus pose evidence | 1723 | 1852 | 1834 |
|    the DEFAULT with the old top_n=10 screen | 1264 | 1254 | 1326 |
|    the DEFAULT with the old top_n=10 screen and no pose evidence | 1226 | 1212 | 1295 |
| + top-K=20 alone (no re-rank) | 81 | 76 | 93 |
| + top-K + PADM + centre rule  [OVERFIT] | 615 | 572 | 699 |
| + wide dense refit, unscreened  [slower AND worse] | 1882 | 1800 | 2180 |
| + centre rule on the default  [prior absent here] | 1248 | 1242 | 1469 |
| + coarse-level consensus re-rank  [HARMFUL] | 697 | 712 | 892 |
| + max-likelihood re-rank (Poisson-Gauss)  [NO GAIN] | 1078 | 1032 | 1240 |
| + row destripe  [HARMFUL] | 107 | 100 | 118 |
| + median filter on baseline  [no effect WITHOUT impulse noise] | 90 | 80 | 101 |
| + Anscombe A1  [no effect on argmax] | 160 | 138 | 175 |
| + ECC affine  [never converges] | 96 | 82 | 106 |
