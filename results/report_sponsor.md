...
| Mean error | 10.515 px |
| p95 error | 57.876 px |
| Worst-case error | 95.17 px |
| Median error, correctly-located pairs only | 0.208 px |
...
| Group | n | Median err (px) | Mis-lock rate | Pass@1px |
|---|---|---|---|---|
| 124..333 | 10 | 0.214 | 40% | 60% |
| 333..455 | 10 | 0.347 | 30% | 70% |
| 455..687 | 10 | 0.283 | 20% | 70% |
| 687..928 | 10 | 0.301 | 10% | 90% |
